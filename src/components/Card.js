...
import travel_svg from '../icons/travel_plans.svg'
export default function Card(props){
    return (
        <div className='card'>
            <img src={props.imageUrl} width={126} height={168} className='card-img m-20' alt='img'></img>
            <div className="card--place">
                <img src={travel_svg} alt="travel_svg" />
